...
<div class="section">
  ...
  <div class="secwrapper">
      <div class="secrow">
          <div class="secleft">
            <a href="cps"><div class="chart rounded-div"><canvas id="workforceChartCPSBDQTR2"></canvas></div></a>
          </div>
          <div class="secright">
            <a href="pse"><div class="chart rounded-div"><canvas id="workforceChartCPSPOQTR2"></canvas></div></a>
          </div>
      </div>
  </div>
</div>
...
/* SECTION : SALES & BD 2
*/
const ctxqtrbd2 = document.getElementById('workforceChartCPSBDQTR2');
  new Chart (ctxqtrbd2, {
    type: 'bar',
    displayColors: true,
    interaction: {
